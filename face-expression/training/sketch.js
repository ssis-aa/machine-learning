// https://editor.p5js.org/kreier/sketches/3QlIFiVqK
...
let categories = ["surprised", "happy", "neutral", "angry", "sad", "other"];

let INPUT_FILE = "/data/faceTraining.csv";
var categoryButtons = {};
...
function setup() {
  ...
  // This portion of the code sets up the inputs for 
  // the machine learning algorithm from the CSV file.
  const options = {
  ...
  // The code below gets the data from the loaded CSV file 
  // and stores it in input/output arrays to be read into 
  // the neural network.
...
function dataLoaded() {
  ...
  console.log("Data loaded. Now normalizing.")
    nn.normalizeData();
